# PROTOTYPE 5
------
* Code is made shorter than prototype4.
* This prototype was created for analyzing microscopic pictures with maximum 5 photos (less than 5 photo is possible for analyzing now). Moreover, this prototype can be used for analyzing 2 folders as the same time.
* -----
...
```r  
  ...
  ```
# Analyzing size and circularity
```r
