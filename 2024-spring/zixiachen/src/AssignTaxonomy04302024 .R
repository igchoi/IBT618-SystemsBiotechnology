...
path <- "/Users/livia/Desktop/Daqu sample/R analysis-4.30/Rawdata" 
list.files(path)
...
out <- filterAndTrim(fnFs,filtFs,truncLen = 150, trimLeft = 17,
                     maxEE = 2,maxN=2,truncQ = 2,rm.phix = TRUE,compress=TRUE, 
                     multithread = T)
head(out)
...
write.csv(seqtab.nochim,file="/Users/livia/Desktop/Daqu sample/R analysis-4.30/Rawdata/filtered/ASV.CSV",
